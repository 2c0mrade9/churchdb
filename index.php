<?php
//include the most important files needed for the website
require_once('assets/theme/common.template.php');
...
$ACTION = (
	...
	($URL == 'index.php') ||
	($URL == 'index.html')
) ? array('dashboard') : explode('/', html_entity_decode($URL));
/*
	...
	pages/default.php
*/
$includeFile = 'pages/'.preg_replace('/[^\w]-/','',strtolower($ACTION[0])).'.php';
